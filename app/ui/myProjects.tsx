                            ...
                            <div className="row row-cols-1 row-cols-lg-2">
                                    ...
                                    <div className="card mb-3" style="max-width: 540px;">
                                        <div className="row g-0">
                                            <div className="col-md-4">
                                                <img src="images/money.jpeg" className="img-fluid rounded-start" alt="Finance app logo"/>
                                            </div>
                                ...
                                <div className="col">
                                    <div className="card mb-3" style="max-width: 540px;">
                                        <div className="row g-0">
                                            <div className="col-md-4">
                                                <img src="/images/delorean.jpg" className="img-fluid rounded-start" alt="">
                                            </div>
                                            <div className="col-md-8">
                                                <div className="card-body">
                            ...
                            <div className="row row-cols-1 row-cols-lg-2">
                                <div className="col">
                                    <div className="card mb-3" style="max-width: 540px;">
                                        <div className="row g-0">
                                            <div className="col-md-4">
                                                <img src="/images/banner-sm.jpg" className="img-fluid rounded-start" alt="">
                                            </div>
                                            <div className="col-md-8">
                                                <div className="card-body">
                                ...
                                <div className="col">
                                    <div className="card mb-3" style="max-width: 540px;">
                                        <div className="row g-0">
                                            <div className="col-md-4">
                                                <img src="/images/N-animez.jpeg" className="img-fluid rounded-start" alt="">
                                            </div>
                                            <div className="col-md-8">
                                                <div className="card-body">
